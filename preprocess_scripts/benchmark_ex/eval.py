...
if args.cascades:
    ...
    cascades_dict = None
#establish  a connection to redis db a localhost supposedly will be possible for loopback
# please enter the IP of the GCP IP
...
@execute(predict_function=music_predict,
...
if __name__ == '__main__':
    ...
    print("Time %fs Num Rows %d Throughput %f rows/sec" %
