...
from mus_utils import get_features_from_redis, music_train, music_predict, music_confidence, music_score, \
...
@execute(train_function=music_train,
...
if __name__ == '__main__':
    ...
    model = pipeline(train_X, train_y)
